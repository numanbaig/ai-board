  ...
  return {
    ...
    blocks: [
      ...
      },
      {
        ...
        width: 200,
        height: 76,
        props: { text: "Let's add 2 + 2!", fontSize: 14 },
        zIndex: 2,
        groupId: "demo-add-line",
      },
      {
        ...
        width: 300,
        height: 64,
        props: { min: 0, max: 6, start: 0, hops: [2, 2] },
        label: "Hop by hop",
        zIndex: 2,
        groupId: "demo-add-line",
      },
  ...
  return {
    ...
    blocks: [
      ...
      },
      {
        ...
        width: 100,
        height: 88,
        props: { tone: "hot", regionLabel: "Warm air" },
        zIndex: 2,
        groupId: "demo-wind",
      },
      {
        ...
        width: 100,
        height: 88,
        props: { tone: "cold", regionLabel: "Cool air" },
        zIndex: 2,
        groupId: "demo-wind",
      },
      {
      ...
      },
      {
        ...
        width: 200,
        height: 36,
        props: { direction: "right", color: "#38bdf8" },
        zIndex: 2,
        groupId: "demo-wind",
      },
      {
